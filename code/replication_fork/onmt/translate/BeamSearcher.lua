...
function BeamSearcher:search(tag_weight, delStartId, delEndId, insStartId, insEndId, beamSize, nBest, preFilterFactor, keepInitial)
  ...
  while remaining > 0 do
    ...
    scores:select(2, delStartId):add(tag_weight)
    scores:select(2, delEndId):add(tag_weight)
    scores:select(2, insStartId):add(tag_weight)
    scores:select(2, insEndId):add(tag_weight)
