...
function Translator:translateBatch(batch)
  ...
  local results = beamSearcher:search(self.opt.tag_weight, self.dicts.tgt.words:lookup("<del>"), self.dicts.tgt.words:lookup("</del>"), self.dicts.tgt.words:lookup("<ins>"), self.dicts.tgt.words:lookup("</ins>"), self.opt.beam_size, self.opt.n_best, self.opt.pre_filter_factor)
