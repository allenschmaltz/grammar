...
def translate_opts(parser):
    ...
    group.add_argument('-constrained_nbest_output', default='constrained_nbest_pred.txt',
                       help="""Path to output the constrained nbest predictions (each sentence will
                       have at most nbest decoded sequences). Only used if n_best > 1.""")
    ...
    group.add_argument('-tag_weight',  type=float, default=0.0,
                       help='Tag weight')
